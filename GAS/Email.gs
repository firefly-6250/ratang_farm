...
<div style="margin:0; padding:0; background-color:#f8f5f0;">
  <div style="max-width:620px; margin:60px auto; padding:0 24px;">
    ...
    ">
      ...
      <p>
        我們的果園座落於合歡山西側半山腰上，這裡的水蜜桃歷經了高海拔日夜溫差的嚴苛考驗，開花、結成果實；我們堅持減藥與友善土地的耕作方式，全程仰賴人工除草與雙手細心採摘，每一顆果實都是我們對土地的承諾。
      </p>

      <p>
        因為減少用藥，加上水蜜桃極為嬌嫩，我們在採收、選果及包裝的每一個細節都加倍小心。為了讓這份美好完好如初地送達，我們特別在果實七、八分熟時鮮採，並全程冷藏出貨。
      </p>

      <p>
        果園目前正依據果實的成熟狀態安排採收與訂單順序排單出貨，出貨當天，我們會發送通知給您，請您安心期待，並等候黑貓宅配到貨通知。
      </p>

      <p>
        希望在您開箱的那一刻，迎面而來的撲鼻果香，能讓您感受到來自產地的問候。再次謝謝您的等待與支持。
      </p>
